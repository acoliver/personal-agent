...
impl ProfileEditorView {
    ...
    const fn advanced_request_parameters_active_field(&self) -> bool {
        matches!(
    ...
    fn render_advanced_request_parameters_toggle(
        expanded: bool,
        cx: &mut gpui::Context<Self>,
    ) -> impl IntoElement {
        div()
    ...
    fn render_max_tokens_field_name_advanced_section(
        &self,
        field_active: bool,
        cx: &mut gpui::Context<Self>,
    ) -> impl IntoElement {
    ...
    fn render_extra_request_fields_editor(
        &self,
    ...
    fn validate_advanced_request_json(&self) {
    ...
    fn render_advanced_request_parameter_actions(cx: &mut gpui::Context<Self>) -> impl IntoElement {
        div()
            .flex()
            .items_center()
            .gap(px(8.0))
    ...
    fn render_advanced_request_parameters_section(
        &self,
        cx: &mut gpui::Context<Self>,
    ) -> impl IntoElement {
