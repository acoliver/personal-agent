...
pub fn create_app_menu_with_shortcuts(mtm: MainThreadMarker) -> Retained<NSMenu> {
    ...
    unsafe {
        ...
        add_menu_item(
            ...
            mtm,
            "Rename Conversation",
            sel!(renameConversationShortcut:),
            "r",
            true,
            true,
        );
