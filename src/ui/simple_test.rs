...
use objc2_app_kit::{
    NSButton, NSColor, NSFont, NSLayoutConstraintOrientation, NSScrollView, NSStackView,
...
"
    ...
    fn build_chat_area(&self, mtm: MainThreadMarker) -> Retained<NSScrollView> {
        ...
        */
        ...
        label1.setFrame(NSRect::new(
            NSPoint::new(10.0, 360.0),
            NSSize::new(380.0, 20.0),
        ));
        content.addSubview(&label1);

        let label2 = NSTextField::labelWithString(
            &NSString::from_str("Assistant: Hi there! How can I help?"),
            mtm,
        );
        label2.setTextColor(Some(&NSColor::systemGrayColor()));
        label2.setFrame(NSRect::new(
            NSPoint::new(10.0, 330.0),
            NSSize::new(380.0, 20.0),
        ));
    ...
    fn build_input_bar(&self, mtm: MainThreadMarker) -> Retained<NSStackView> {
        ...
        */
        ...
        text_field.setContentHuggingPriority_forOrientation(
            1.0,
            NSLayoutConstraintOrientation::Horizontal,
        );
