...
// map_input_char tests removed: character mapping is now handled by the
// macOS IME pipeline (EntityInputHandler::replace_text_in_range) instead
// of manual ASCII shift mapping.
